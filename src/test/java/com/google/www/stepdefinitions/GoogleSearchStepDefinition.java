...
public class GoogleSearchStepDefinition {
    ...
    @Then("you should see the result of the search the title {string} and {string}")
    public void youShouldSeeTheResultOfTheSearchTheTitleAnd(String title, String searchTerms) {
